...
export const Auth: React.FC<AuthProps> = ({ onAuthSuccess, themeColor }) => {
  ...
  const handleSocialLogin = (provider: 'github' | 'google') => {
    ...
    alert(`O login com ${provider} está configurado no sistema. Redirecionando...`);
  };
          ...
          <div className="mt-8">
            ...
            <div className="grid grid-cols-3 gap-2">
              <button 
                ...
                className="flex flex-col items-center justify-center gap-1 bg-white/5 border border-white/10 text-white py-3 rounded-xl hover:bg-white/10 transition text-[10px] font-medium"
              >
